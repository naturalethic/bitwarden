...
import { OrganizationUserDetailsResponse, OrganizationUserUserDetailsResponse } from '../models/response/organizationUserResponse';
...
export declare class ApiService implements ApiServiceAbstraction {
    ...
    private deviceType;
    private isWebClient;
    private isDesktopClient;
    private usingBaseUrl;
    ...
    postShareCipherAttachment(id: string, attachmentId: string, data: FormData, organizationId: string): Promise<any>;
    ...
    postOrganizationUserAccept(organizationId: string, id: string, request: OrganizationUserAcceptRequest): Promise<any>;
    postOrganizationUserConfirm(organizationId: string, id: string, request: OrganizationUserConfirmRequest): Promise<any>;
    putOrganizationUser(organizationId: string, id: string, request: OrganizationUserUpdateRequest): Promise<any>;
    putOrganizationUserGroups(organizationId: string, id: string, request: OrganizationUserUpdateGroupsRequest): Promise<any>;
    ...
    getTwoFactorOrganizationDuo(organizationId: string, request: PasswordVerificationRequest): Promise<TwoFactorDuoResponse>;
    ...
    putTwoFactorAuthenticator(request: UpdateTwoFactorAuthenticatorRequest): Promise<TwoFactorAuthenticatorResponse>;
    putTwoFactorEmail(request: UpdateTwoFactorEmailRequest): Promise<TwoFactorEmailResponse>;
    putTwoFactorDuo(request: UpdateTwoFactorDuoRequest): Promise<TwoFactorDuoResponse>;
    putTwoFactorOrganizationDuo(organizationId: string, request: UpdateTwoFactorDuoRequest): Promise<TwoFactorDuoResponse>;
    ...
    putTwoFactorOrganizationDisable(organizationId: string, request: TwoFactorProviderRequest): Promise<TwoFactorProviderResponse>;
    ...
    getEventsOrganization(id: string, start: string, end: string, token: string): Promise<ListResponse<EventResponse>>;
    getEventsOrganizationUser(organizationId: string, id: string, start: string, end: string, token: string): Promise<ListResponse<EventResponse>>;
