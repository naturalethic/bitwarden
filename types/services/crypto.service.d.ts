...
export declare class CryptoService implements CryptoServiceAbstraction {
    ...
    private privateKey;
    private orgKeys;
    constructor(storageService: StorageService, secureStorageService: StorageService, cryptoFunctionService: CryptoFunctionService);
    ...
    private aesEncrypt;
    private aesDecryptToUtf8;
    private aesDecryptToBytes;
    private rsaDecrypt;
    private getKeyForEncryption;
